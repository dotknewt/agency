...
| `instruction-management` | 1.2.2 | Audit and maintain AGENTS.md; nudges `/revise-instructions` on busy sessions | `/revise-instructions`, `/restructure-instructions`, `instruction-management` skill |
